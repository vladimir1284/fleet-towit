...
const Maintenance = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon || missing_component, "svelte:component").$$render($$result, {}, {}, {})} ${$$slots.h1 ? `<h1${add_attribute("class", twMerge(h1Class, $$props.classH1), 0)}>${slots.h1 ? slots.h1({}) : ``}</h1>` : ``} ${$$slots.paragraph ? `<p${add_attribute("class", twMerge(pClass, $$props.classP), 0)}>${slots.paragraph ? slots.paragraph({}) : ``}</p>` : ``} `;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${`${validate_component(Section, "Section").$$render($$result, { name: "maintenance" }, {}, {
    default: () => {
      return `${validate_component(Maintenance, "Maintenance").$$render($$result, {}, {}, {
        paragraph: () => {
          return `Our Enterprise administrators are performing scheduled maintenance.`;
        },
        h1: () => {
...
//# sourceMappingURL=_page.svelte-4608e0f8.js.map
