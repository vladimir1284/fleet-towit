  ...
  <div>
    <Sidebar {activeUrl}>
      <SidebarWrapper class="bg-white">
        <SidebarGroup>
          <SidebarItem label="Dashboard" href="/auth/signin">
          ...
          <SidebarItem label="Inspections" href="/pepe">
            <svelte:fragment slot="icon">
          ...
          <SidebarItem label="Maintenance" href="/docs/components/alert">
            <svelte:fragment slot="icon">
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          ...
          <SidebarItem label="Assets" href="/docs/components/sidebar">
            <svelte:fragment slot="icon">
          ...
          <SidebarItem label="Reminders" href="/badge">
            <svelte:fragment slot="icon">
          ...
          <SidebarItem label="Reports" href="/badge">
            <svelte:fragment slot="icon">
    ...
    <Button class="w-[10%]" color="dark" outline on:click={() => {showSidebar = false}}>X</Button>
  </div>
{/if}
