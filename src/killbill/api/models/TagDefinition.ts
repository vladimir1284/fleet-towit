...
export function TagDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): TagDefinition {
    ...
    return {
        ...
        'applicableObjectTypes': !exists(json, 'applicableObjectTypes') ? undefined : json['applicableObjectTypes'],
...
export function TagDefinitionToJSON(value?: TagDefinition | null): any {
    ...
    return {
        ...
        'applicableObjectTypes': value.applicableObjectTypes === undefined ? undefined : Array.from(value.applicableObjectTypes as Set<any>),
