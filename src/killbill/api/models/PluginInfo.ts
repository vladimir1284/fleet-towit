...
export function PluginInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): PluginInfo {
    ...
    return {
        ...
        'bundleSymbolicName': !exists(json, 'bundleSymbolicName') ? undefined : json['bundleSymbolicName'],
        ...
        'isSelectedForStart': !exists(json, 'isSelectedForStart') ? undefined : json['isSelectedForStart'],
        'services': !exists(json, 'services') ? undefined : (new Set((json['services'] as Array<any>).map(PluginServiceInfoFromJSON))),
    };
}
...
export function PluginInfoToJSON(value?: PluginInfo | null): any {
    ...
    return {
        ...
        'services': value.services === undefined ? undefined : (Array.from(value.services as Set<any>).map(PluginServiceInfoToJSON)),
    };
}
