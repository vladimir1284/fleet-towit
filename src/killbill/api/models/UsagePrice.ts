...
export function UsagePriceFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsagePrice {
    ...
    return {
        ...
        'tierPrices': !exists(json, 'tierPrices') ? undefined : ((json['tierPrices'] as Array<any>).map(TierPriceFromJSON)),
    };
}
...
export function UsagePriceToJSON(value?: UsagePrice | null): any {
    ...
    return {
        ...
        'tierPrices': value.tierPrices === undefined ? undefined : ((value.tierPrices as Array<any>).map(TierPriceToJSON)),
    };
}
