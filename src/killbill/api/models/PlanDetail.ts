...
export type PlanDetailFinalPhaseBillingPeriodEnum =
	(typeof PlanDetailFinalPhaseBillingPeriodEnum)[keyof typeof PlanDetailFinalPhaseBillingPeriodEnum];
...
export function PlanDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanDetail {
	...
	return {
		...
		finalPhaseBillingPeriod: !exists(json, 'finalPhaseBillingPeriod')
			? undefined
			: json['finalPhaseBillingPeriod'],
		finalPhaseRecurringPrice: !exists(json, 'finalPhaseRecurringPrice')
			? undefined
			: (json['finalPhaseRecurringPrice'] as Array<any>).map(PriceFromJSON)
	};
}
...
export function PlanDetailToJSON(value?: PlanDetail | null): any {
	...
	return {
		...
		finalPhaseRecurringPrice:
			value.finalPhaseRecurringPrice === undefined
				? undefined
				: (value.finalPhaseRecurringPrice as Array<any>).map(PriceToJSON)
	};
}
