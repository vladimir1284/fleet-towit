...
export function NodeInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): NodeInfo {
    ...
    return {
        ...
        'pluginsInfo': !exists(json, 'pluginsInfo') ? undefined : ((json['pluginsInfo'] as Array<any>).map(PluginInfoFromJSON)),
    };
}
...
export function NodeInfoToJSON(value?: NodeInfo | null): any {
    ...
    return {
        ...
        'pluginsInfo': value.pluginsInfo === undefined ? undefined : ((value.pluginsInfo as Array<any>).map(PluginInfoToJSON)),
    };
}
