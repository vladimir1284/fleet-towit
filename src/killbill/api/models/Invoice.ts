...
export function InvoiceFromJSONTyped(json: any, ignoreDiscriminator: boolean): Invoice {
    ...
    return {
        ...
        'credits': !exists(json, 'credits') ? undefined : ((json['credits'] as Array<any>).map(InvoiceItemFromJSON)),
...
export function InvoiceToJSON(value?: Invoice | null): any {
    ...
    return {
        ...
        'targetDate': value.targetDate === undefined ? undefined : (value.targetDate.toISOString().substr(0,10)),
        'invoiceNumber': value.invoiceNumber,
        'balance': value.balance,
        'accountId': value.accountId,
        'bundleKeys': value.bundleKeys,
        'credits': value.credits === undefined ? undefined : ((value.credits as Array<any>).map(InvoiceItemToJSON)),
