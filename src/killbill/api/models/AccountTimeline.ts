...
export function AccountTimelineFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountTimeline {
    ...
    return {
        ...
        'bundles': !exists(json, 'bundles') ? undefined : ((json['bundles'] as Array<any>).map(BundleFromJSON)),
        'invoices': !exists(json, 'invoices') ? undefined : ((json['invoices'] as Array<any>).map(InvoiceFromJSON)),
        'payments': !exists(json, 'payments') ? undefined : ((json['payments'] as Array<any>).map(InvoicePaymentFromJSON)),
    };
}
...
export function AccountTimelineToJSON(value?: AccountTimeline | null): any {
    ...
    return {
        ...
        'bundles': value.bundles === undefined ? undefined : ((value.bundles as Array<any>).map(BundleToJSON)),
        'invoices': value.invoices === undefined ? undefined : ((value.invoices as Array<any>).map(InvoiceToJSON)),
        'payments': value.payments === undefined ? undefined : ((value.payments as Array<any>).map(InvoicePaymentToJSON)),
    };
}
