...
export type OverdueStateConfigSubscriptionCancellationPolicyEnum =
	(typeof OverdueStateConfigSubscriptionCancellationPolicyEnum)[keyof typeof OverdueStateConfigSubscriptionCancellationPolicyEnum];
...
export function OverdueStateConfigFromJSONTyped(
	json: any,
	...
	return {
		...
		isDisableEntitlement: !exists(json, 'isDisableEntitlement')
			? undefined
			: json['isDisableEntitlement'],
		subscriptionCancellationPolicy: !exists(json, 'subscriptionCancellationPolicy')
			? undefined
			: json['subscriptionCancellationPolicy'],
		autoReevaluationIntervalDays: !exists(json, 'autoReevaluationIntervalDays')
			? undefined
			: json['autoReevaluationIntervalDays']
	};
}
