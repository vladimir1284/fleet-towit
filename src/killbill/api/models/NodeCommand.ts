...
export function NodeCommandFromJSONTyped(json: any, ignoreDiscriminator: boolean): NodeCommand {
    ...
    return {
        ...
        'isSystemCommandType': !exists(json, 'isSystemCommandType') ? undefined : json['isSystemCommandType'],
        'nodeCommandType': !exists(json, 'nodeCommandType') ? undefined : json['nodeCommandType'],
        'nodeCommandProperties': !exists(json, 'nodeCommandProperties') ? undefined : ((json['nodeCommandProperties'] as Array<any>).map(NodeCommandPropertyFromJSON)),
    };
}
...
export function NodeCommandToJSON(value?: NodeCommand | null): any {
    ...
    return {
        ...
        'nodeCommandProperties': value.nodeCommandProperties === undefined ? undefined : ((value.nodeCommandProperties as Array<any>).map(NodeCommandPropertyToJSON)),
    };
}
