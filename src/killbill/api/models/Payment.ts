...
export function PaymentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Payment {
    ...
    return {
        ...
        'transactions': !exists(json, 'transactions') ? undefined : ((json['transactions'] as Array<any>).map(PaymentTransactionFromJSON)),
        'paymentAttempts': !exists(json, 'paymentAttempts') ? undefined : ((json['paymentAttempts'] as Array<any>).map(PaymentAttemptFromJSON)),
...
export function PaymentToJSON(value?: Payment | null): any {
    ...
    return {
        ...
        'transactions': value.transactions === undefined ? undefined : ((value.transactions as Array<any>).map(PaymentTransactionToJSON)),
        'paymentAttempts': value.paymentAttempts === undefined ? undefined : ((value.paymentAttempts as Array<any>).map(PaymentAttemptToJSON)),
