...
export function PhaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Phase {
    ...
    return {
        ...
        'fixedPrices': !exists(json, 'fixedPrices') ? undefined : ((json['fixedPrices'] as Array<any>).map(PriceFromJSON)),
...
export function PhaseToJSON(value?: Phase | null): any {
    ...
    return {
        ...
        'fixedPrices': value.fixedPrices === undefined ? undefined : ((value.fixedPrices as Array<any>).map(PriceToJSON)),
