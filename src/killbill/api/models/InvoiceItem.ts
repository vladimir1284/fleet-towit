...
export function InvoiceItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceItem {
    ...
    return {
        ...
        'linkedInvoiceItemId': !exists(json, 'linkedInvoiceItemId') ? undefined : json['linkedInvoiceItemId'],
        ...
        'catalogEffectiveDate': !exists(json, 'catalogEffectiveDate') ? undefined : (new Date(json['catalogEffectiveDate'])),
        'childItems': !exists(json, 'childItems') ? undefined : ((json['childItems'] as Array<any>).map(InvoiceItemFromJSON)),
...
export function InvoiceItemToJSON(value?: InvoiceItem | null): any {
    ...
    return {
        ...
        'catalogEffectiveDate': value.catalogEffectiveDate === undefined ? undefined : (value.catalogEffectiveDate.toISOString()),
        'childItems': value.childItems === undefined ? undefined : ((value.childItems as Array<any>).map(InvoiceItemToJSON)),
