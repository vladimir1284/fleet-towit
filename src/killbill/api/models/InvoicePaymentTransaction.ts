...
export type InvoicePaymentTransactionTransactionTypeEnum =
	(typeof InvoicePaymentTransactionTransactionTypeEnum)[keyof typeof InvoicePaymentTransactionTransactionTypeEnum];
...
export type InvoicePaymentTransactionCurrencyEnum =
	(typeof InvoicePaymentTransactionCurrencyEnum)[keyof typeof InvoicePaymentTransactionCurrencyEnum];
...
export type InvoicePaymentTransactionProcessedCurrencyEnum =
	(typeof InvoicePaymentTransactionProcessedCurrencyEnum)[keyof typeof InvoicePaymentTransactionProcessedCurrencyEnum];
...
export type InvoicePaymentTransactionStatusEnum =
	(typeof InvoicePaymentTransactionStatusEnum)[keyof typeof InvoicePaymentTransactionStatusEnum];
...
export function InvoicePaymentTransactionFromJSONTyped(
	json: any,
	...
	return {
		...
		adjustments: !exists(json, 'adjustments')
			? undefined
			: (json['adjustments'] as Array<any>).map(InvoiceItemFromJSON),
	...
	return {
		...
		adjustments:
			value.adjustments === undefined
				? undefined
				: (value.adjustments as Array<any>).map(InvoiceItemToJSON),
		auditLogs:
