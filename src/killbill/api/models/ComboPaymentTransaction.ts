...
export function ComboPaymentTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComboPaymentTransaction {
    ...
    return {
        ...
        'transaction': !exists(json, 'transaction') ? undefined : PaymentTransactionFromJSON(json['transaction']),
        ...
        'transactionPluginProperties': !exists(json, 'transactionPluginProperties') ? undefined : ((json['transactionPluginProperties'] as Array<any>).map(PluginPropertyFromJSON)),
...
export function ComboPaymentTransactionToJSON(value?: ComboPaymentTransaction | null): any {
    ...
    return {
        ...
        'transactionPluginProperties': value.transactionPluginProperties === undefined ? undefined : ((value.transactionPluginProperties as Array<any>).map(PluginPropertyToJSON)),
