...
import type { AuditLog, Tag } from '../models';
import { AuditLogFromJSON, AuditLogToJSON, TagFromJSON, TagToJSON } from '../models';
...
export class TagApi extends runtime.BaseAPI {
	 ...
	 */
	async getTagAuditLogsWithHistoryRaw(
		requestParameters: GetTagAuditLogsWithHistoryRequest,
		...
		if (requestParameters.tagId === null || requestParameters.tagId === undefined) {
			throw new runtime.RequiredError(
				'tagId',
				'Required parameter requestParameters.tagId was null or undefined when calling getTagAuditLogsWithHistory.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/tags/{tagId}/auditLogsWithHistory`.replace(
					`{${'tagId'}}`,
	 ...
	 * Retrieve tag audit logs with history by id
	 */
	async getTagAuditLogsWithHistory(
		requestParameters: GetTagAuditLogsWithHistoryRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	...
	async searchTagsRaw(
		...
		if (requestParameters.searchKey === null || requestParameters.searchKey === undefined) {
			throw new runtime.RequiredError(
				'searchKey',
				'Required parameter requestParameters.searchKey was null or undefined when calling searchTags.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/tags/search/{searchKey}`.replace(
					`{${'searchKey'}}`,
