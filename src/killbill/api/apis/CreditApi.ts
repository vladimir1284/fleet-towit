...
export class CreditApi extends runtime.BaseAPI {
     ...
     * Create a credit
     */
    async createCreditsRaw(requestParameters: CreateCreditsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<InvoiceItem>>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling createCredits.');
        }

        if (requestParameters.xKillbillCreatedBy === null || requestParameters.xKillbillCreatedBy === undefined) {
            throw new runtime.RequiredError('xKillbillCreatedBy','Required parameter requestParameters.xKillbillCreatedBy was null or undefined when calling createCredits.');
        }
     ...
     * Create a credit
     */
    async createCredits(requestParameters: CreateCreditsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<InvoiceItem>> {
     ...
     */
    async getCreditRaw(requestParameters: GetCreditRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<InvoiceItem>> {
        if (requestParameters.creditId === null || requestParameters.creditId === undefined) {
            throw new runtime.RequiredError('creditId','Required parameter requestParameters.creditId was null or undefined when calling getCredit.');
        }
        ...
        const response = await this.request({
            path: `/1.0/kb/credits/{creditId}`.replace(`{${"creditId"}}`, encodeURIComponent(String(requestParameters.creditId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Retrieve a credit by id
     */
    async getCredit(requestParameters: GetCreditRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InvoiceItem> {
