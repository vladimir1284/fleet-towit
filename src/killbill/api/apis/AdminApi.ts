...
import type { AdminPayment } from '../models';
import { AdminPaymentFromJSON, AdminPaymentToJSON } from '../models';
...
export class AdminApi extends runtime.BaseAPI {
	 ...
	 * Get queues entries
	 */
	async getQueueEntriesRaw(
		requestParameters: GetQueueEntriesRequest,
	 ...
	 */
	async invalidatesCacheRaw(
		requestParameters: InvalidatesCacheRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		const queryParameters: any = {};
	 ...
	 */
	async invalidatesCacheByAccountRaw(
		requestParameters: InvalidatesCacheByAccountRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		if (requestParameters.accountId === null || requestParameters.accountId === undefined) {
			throw new runtime.RequiredError(
				'accountId',
				'Required parameter requestParameters.accountId was null or undefined when calling invalidatesCacheByAccount.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/admin/cache/accounts/{accountId}`.replace(
					`{${'accountId'}}`,
	 ...
	 * Invalidates Caches per account level
	 */
	async invalidatesCacheByAccount(
		requestParameters: InvalidatesCacheByAccountRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<void> {
	 ...
	 */
	async invalidatesCacheByTenantRaw(
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		const queryParameters: any = {};
	 ...
	 * Invalidates Caches per tenant level
	 */
	async invalidatesCacheByTenant(
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<void> {
	 ...
	 */
	async triggerInvoiceGenerationForParkedAccountsRaw(
		requestParameters: TriggerInvoiceGenerationForParkedAccountsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		if (
			...
			throw new runtime.RequiredError(
				'xKillbillCreatedBy',
				'Required parameter requestParameters.xKillbillCreatedBy was null or undefined when calling triggerInvoiceGenerationForParkedAccounts.'
			);
		}
	 ...
	 * Trigger an invoice generation for all parked accounts
	 */
	async triggerInvoiceGenerationForParkedAccounts(
		requestParameters: TriggerInvoiceGenerationForParkedAccountsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<void> {
	 ...
	 */
	async updatePaymentTransactionStateRaw(
		requestParameters: UpdatePaymentTransactionStateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		if (requestParameters.body === null || requestParameters.body === undefined) {
			throw new runtime.RequiredError(
				'body',
				'Required parameter requestParameters.body was null or undefined when calling updatePaymentTransactionState.'
			);
		}
		...
		if (requestParameters.paymentId === null || requestParameters.paymentId === undefined) {
			throw new runtime.RequiredError(
				'paymentId',
				'Required parameter requestParameters.paymentId was null or undefined when calling updatePaymentTransactionState.'
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				...
				'Required parameter requestParameters.paymentTransactionId was null or undefined when calling updatePaymentTransactionState.'
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				'xKillbillCreatedBy',
				'Required parameter requestParameters.xKillbillCreatedBy was null or undefined when calling updatePaymentTransactionState.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/admin/payments/{paymentId}/transactions/{paymentTransactionId}`
					.replace(`{${'paymentId'}}`, encodeURIComponent(String(requestParameters.paymentId)))
					.replace(
						`{${'paymentTransactionId'}}`,
	 ...
	 * Update existing paymentTransaction and associated payment state
	 */
	async updatePaymentTransactionState(
		requestParameters: UpdatePaymentTransactionStateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<void> {
