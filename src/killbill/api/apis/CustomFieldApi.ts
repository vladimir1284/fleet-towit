...
import type { AuditLog, CustomField } from '../models';
import {
	AuditLogFromJSON,
	AuditLogToJSON,
	CustomFieldFromJSON,
...
export class CustomFieldApi extends runtime.BaseAPI {
	 ...
	 */
	async getCustomFieldAuditLogsWithHistoryRaw(
		requestParameters: GetCustomFieldAuditLogsWithHistoryRequest,
		...
		if (requestParameters.customFieldId === null || requestParameters.customFieldId === undefined) {
			throw new runtime.RequiredError(
				'customFieldId',
				'Required parameter requestParameters.customFieldId was null or undefined when calling getCustomFieldAuditLogsWithHistory.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/customFields/{customFieldId}/auditLogsWithHistory`.replace(
					`{${'customFieldId'}}`,
					encodeURIComponent(String(requestParameters.customFieldId))
				),
				method: 'GET',
	 ...
	 * Retrieve custom field audit logs with history by id
	 */
	async getCustomFieldAuditLogsWithHistory(
		requestParameters: GetCustomFieldAuditLogsWithHistoryRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<Array<AuditLog>> {
		const response = await this.getCustomFieldAuditLogsWithHistoryRaw(
			requestParameters,
			initOverrides
		);
	 ...
	 */
	async searchCustomFieldsRaw(
		requestParameters: SearchCustomFieldsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<Array<CustomField>>> {
		if (requestParameters.searchKey === null || requestParameters.searchKey === undefined) {
			throw new runtime.RequiredError(
				'searchKey',
				'Required parameter requestParameters.searchKey was null or undefined when calling searchCustomFields.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/customFields/search/{searchKey}`.replace(
					`{${'searchKey'}}`,
	 ...
	 */
	async searchCustomFieldsByTypeNameRaw(
		requestParameters: SearchCustomFieldsByTypeNameRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<Array<CustomField>>> {
		const queryParameters: any = {};
	 ...
	 * Search custom fields by type, name and optional value
	 */
	async searchCustomFieldsByTypeName(
		requestParameters: SearchCustomFieldsByTypeNameRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<Array<CustomField>> {
...
export type GetCustomFieldsAuditEnum =
	(typeof GetCustomFieldsAuditEnum)[keyof typeof GetCustomFieldsAuditEnum];
/**
 * @export
 */
...
export type SearchCustomFieldsAuditEnum =
	(typeof SearchCustomFieldsAuditEnum)[keyof typeof SearchCustomFieldsAuditEnum];
/**
 * @export
 */
...
export type SearchCustomFieldsByTypeNameAuditEnum =
	(typeof SearchCustomFieldsByTypeNameAuditEnum)[keyof typeof SearchCustomFieldsByTypeNameAuditEnum];
