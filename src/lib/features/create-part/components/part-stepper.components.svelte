...
<ol
	class="items-center w-full space-y-4 sm:flex sm:justify-between sm:space-x-8 sm:space-y-0 rtl:space-x-reverse mb-10"
>
	<li class="flex items-center text-blue-600 dark:text-blue-500 space-x-2.5 rtl:space-x-reverse">
		...
		<span>
			<h3 class="font-medium leading-tight">Part description</h3>
		</span>
	</li>
	<li class="flex items-center text-gray-500 dark:text-gray-400 space-x-2.5 rtl:space-x-reverse">
		...
		<span>
			<h3 class="font-medium leading-tight">Part customization</h3>
		</span>
	</li>
</ol>
