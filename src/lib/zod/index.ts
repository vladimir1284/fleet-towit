...
export const PartScalarFieldEnumSchema = z.enum(['id','name','number','criticalQty','upc','description','extendedPartData','image','createdAt','updatedAt','deletedAt','createdBy','updatedBy','deletedBy']);
