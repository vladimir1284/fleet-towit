...
export const getTrackerByVehicleId = async (
...
export const getAllHeartBeatsByTrackerId = async (
	instance: PrismaClient,
	{ trackerId }: { trackerId: number }
) => {
...
export const addHeartBeat = async (
	instance: PrismaClient,
	{ lat, long, timestamp, trackerId }: heartBeatType
) => {
