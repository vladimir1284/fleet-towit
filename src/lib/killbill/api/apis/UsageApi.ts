...
import type { RolledUpUsage, SubscriptionUsageRecord } from '../models';
import {
...
export class UsageApi extends runtime.BaseAPI {
	 ...
	 */
	async getAllUsageRaw(
		requestParameters: GetAllUsageRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<RolledUpUsage>> {
		if (
			...
			throw new runtime.RequiredError(
				'subscriptionId',
				'Required parameter requestParameters.subscriptionId was null or undefined when calling getAllUsage.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/usages/{subscriptionId}`.replace(
					`{${'subscriptionId'}}`,
	 ...
	 */
	async getUsageRaw(
		requestParameters: GetUsageRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<RolledUpUsage>> {
		if (
			requestParameters.subscriptionId === null ||
			...
			throw new runtime.RequiredError(
				'subscriptionId',
				'Required parameter requestParameters.subscriptionId was null or undefined when calling getUsage.'
			);
		}
		...
		if (requestParameters.unitType === null || requestParameters.unitType === undefined) {
			throw new runtime.RequiredError(
				'unitType',
				'Required parameter requestParameters.unitType was null or undefined when calling getUsage.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/usages/{subscriptionId}/{unitType}`
					.replace(
						`{${'subscriptionId'}}`,
						encodeURIComponent(String(requestParameters.subscriptionId))
					)
					.replace(`{${'unitType'}}`, encodeURIComponent(String(requestParameters.unitType))),
				method: 'GET',
				headers: headerParameters,
				query: queryParameters
			},
	 ...
	 */
	async recordUsageRaw(
		requestParameters: RecordUsageRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		if (requestParameters.body === null || requestParameters.body === undefined) {
			throw new runtime.RequiredError(
				'body',
				'Required parameter requestParameters.body was null or undefined when calling recordUsage.'
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				'xKillbillCreatedBy',
				'Required parameter requestParameters.xKillbillCreatedBy was null or undefined when calling recordUsage.'
			);
		}
