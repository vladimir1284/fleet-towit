...
export class ExportApi extends runtime.BaseAPI {
	 ...
	 * Export account data
	 */
	async exportDataForAccountRaw(
		requestParameters: ExportDataForAccountRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		if (requestParameters.accountId === null || requestParameters.accountId === undefined) {
			throw new runtime.RequiredError(
				'accountId',
				'Required parameter requestParameters.accountId was null or undefined when calling exportDataForAccount.'
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				'xKillbillCreatedBy',
				'Required parameter requestParameters.xKillbillCreatedBy was null or undefined when calling exportDataForAccount.'
			);
		}
		...
		const response = await this.request(
			{
				path: `/1.0/kb/export/{accountId}`.replace(
					`{${'accountId'}}`,
