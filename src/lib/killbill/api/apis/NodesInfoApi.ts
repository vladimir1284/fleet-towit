...
import type { NodeCommand, NodeInfo } from '../models';
import {
	NodeCommandFromJSON,
	NodeCommandToJSON,
	NodeInfoFromJSON,
...
export class NodesInfoApi extends runtime.BaseAPI {
	 ...
	 */
	async getNodesInfoRaw(
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<Array<NodeInfo>>> {
	 ...
	 */
	async triggerNodeCommandRaw(
		requestParameters: TriggerNodeCommandRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<void>> {
		if (requestParameters.body === null || requestParameters.body === undefined) {
			throw new runtime.RequiredError(
				'body',
				'Required parameter requestParameters.body was null or undefined when calling triggerNodeCommand.'
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				'xKillbillCreatedBy',
				'Required parameter requestParameters.xKillbillCreatedBy was null or undefined when calling triggerNodeCommand.'
			);
		}
