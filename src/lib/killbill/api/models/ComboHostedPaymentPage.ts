...
export function ComboHostedPaymentPageFromJSONTyped(
	json: any,
	...
	return {
		...
		hostedPaymentPageFields: !exists(json, 'hostedPaymentPageFields')
			? undefined
			: HostedPaymentPageFieldsFromJSON(json['hostedPaymentPageFields']),
