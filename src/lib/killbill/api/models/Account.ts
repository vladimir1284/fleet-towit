...
export function AccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): Account {
	...
	return {
		...
		isPaymentDelegatedToParent: !exists(json, 'isPaymentDelegatedToParent')
			? undefined
			: json['isPaymentDelegatedToParent'],
...
export function AccountToJSON(value?: Account | null): any {
	...
	return {
		...
		referenceTime:
			value.referenceTime === undefined ? undefined : value.referenceTime.toISOString(),
